...
```
urls=""; 
pip install youtube-dl;rm -rf 666;mkdir 666;rm -rf a.py ; wget https://github.com/zhlhlf/text/raw/refs/heads/main/upload-wetransfer.py -O a.py ; cd 666;for i in $urls;do  rm -rf 666/*; youtube-dl $i --external-downloader aria2c --external-downloader-args "-x10" >> /dev/null ; python a.py 666/* ;done
```
